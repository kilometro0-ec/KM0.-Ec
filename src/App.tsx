...
function AppContent() {
  ...
  const notifications = [
    { id: 1, title: 'Nuevo Pedido KM0-REC-992', time: 'Hace 5 min', unread: true, type: 'pedido' },
            ...
            <div className="flex items-center gap-4">
                    ...
                    <>
                      ...
                      >
                        <div className="p-4 bg-gray-50 border-b border-gray-100 flex justify-between items-center">
                          <h3 className="text-xs font-black uppercase tracking-widest text-km0-black">Notificaciones</h3>
                        ...
                        <div className="max-h-96 overflow-y-auto">
                          {notifications.map(n => (
                            ...
                            >
                              <p className="text-sm font-bold text-km0-black group-hover:text-km0-orange transition-colors">{n.title}</p>
                              <p className="text-[10px] text-gray-400 mt-1">{n.time}</p>
                            </div>
                          ))}
                        </div>
                        <button className="w-full p-3 text-[10px] font-bold text-gray-500 hover:text-km0-orange transition-colors bg-gray-50 uppercase tracking-widest border-t border-gray-100">
              ...
              <div className="flex items-center gap-3 pl-2 group cursor-pointer" onClick={handleEditProfile}>
                <div className="text-right hidden sm:block">
                  <p className="text-sm font-bold text-zinc-900 leading-none group-hover:text-km0-orange transition-colors">{user.name}</p>
                ...
                <div className="w-10 h-10 bg-zinc-100 rounded-xl flex items-center justify-center border border-gray-200 group-hover:border-km0-orange transition-all shadow-sm overflow-hidden group-hover:bg-red-50">
                  <User className="w-5 h-5 text-zinc-600 group-hover:text-km0-orange" />
                </div>
              </div>
            </div>
          </div>
              ...
              >
                <div className="p-8">
                  <div className="flex justify-between items-center mb-8">
                    <div>
                      <h3 className="text-2xl font-black italic uppercase tracking-tighter text-km0-black">Editar <span className="text-km0-orange">Perfil</span></h3>
                  ...
                  <form onSubmit={saveProfile} className="space-y-6">
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:border-km0-orange outline-none transition-all font-bold"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="flex gap-4 pt-4">
                      <button type="button" onClick={() => setIsEditingProfile(false)} className="flex-1 px-8 py-4 bg-gray-100 text-km0-black rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-gray-200 transition-colors">Cancelar</button>
